 ...
 *Powered By @${'6282146218274'.split('@')[0]}*`
 ...
     let pp = await conn.profilePictureUrl(who, 'image').catch((_) => "https://telegra.ph/file/2aa124a6bd1fdff4f51d9.png")
 ...
 const fload = {
    ...
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://telegra.ph/file/2aa124a6bd1fdff4f51d9.jpg')).buffer(), //Gambarnye
 ...
 const ftroli = {
    ...
    status: 1,
    surface : 1,
    message: `Khurushi-Md By Riell:3`, 
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://telegra.ph/file/2aa124a6bd1fdff4f51d9.jpg')).buffer(), //Gambarnye
    sellerJid: '0@s.whatsapp.net' 
    }
...
Saya Adalah Khurushi Bot Salah Satu Bot Whatsapp Yang Siap Membantu Kamu Mempermudah Sesuatu Seperti Membuat Sticker Dan Lainnya, Kalo Kamu Mau Request Fitur Silahkan Ketik #request Pesan Atau Fitur Yang Kamu Inginkan!`
...
                 .replace(/%islimit/g, menu.limit ? 'Ⓛ' : '')
 ...
         externalAdReply: { 
             title: 'KhurushiBotz-MD Testing Project By Riell', 
...
type: 'audioMessage', 
ptt: true, contextInfo:{ externalAdReply: { title: `💌 Ultah Riell : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`, body: `${pickRandom(['Follow My Instagram Plis •~•'])}`, sourceUrl: 'https://www.instagram.com/iniRiell/', thumbnail: await (await fetch('https://telegra.ph/file/2aa124a6bd1fdff4f51d9.jpg')).buffer(),}} 
     })
} catch (e) { 
